...
public class WebUsuarioService {
    ...
    private void validarConfimacaoSenha(IConfirmacaoSenha obj) {
    ...
    private void validarCamposUnicos(Usuario usuario) {
       // repository.findByEmail(usuario.getEmail()).ifPresent((usuarioEcontrado) -> {
       //     var mensagem = "Já existe um usuário cadastrado com essse e-mail";
